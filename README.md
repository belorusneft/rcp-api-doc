...
* `scope`: `rcp.api`
* `username`: id организации заправщика.имя пользователя  \\0: {id: 20, label:"РУП "Белоруснефть-Брестоблнефтепродукт""}{id: 160, label: "РУП "Белоруснефть-Витебскоблнефтепродукт""}{id: 370, label: "РУП "Белоруснефть-Гомельоблнефтепродукт""}{id: 520, label: "РУП "Белоруснефть-Гроднооблнефтепродукт""}{id: 530, label: "ОАО "Лиданефтепродукт""}{id: 600, label: "РУП "Белоруснефть-Минскоблнефтепродукт""}{id: 650, label: "РУП "Белоруснефть-Минскавтозаправка""}{id: 720, label: "ОАО "Пуховичинефтепродукт""}{id: 800, label: "РУП "Белоруснефть-Могилевоблнефтепродукт""}{id: 340, label: "ПУ "Связьинформсервис""}
